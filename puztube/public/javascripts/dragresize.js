...
DragResize.prototype.apply=function(node) {
	var obj=this;addEvent(node,'mousedown',function(e){obj.mouseDown(e)});
...
DragResize.prototype.mouseMove=function(e){
	with(this) {
		...
		if(this.resizeHandleDrag&&this.resizeHandleDrag(diffX,diffY)){isResize=true
			...
			else if(elmX+elmW+dX>document.width)mOffX=(dX-(diffX=document.width-elmX-elmW));
		...
		if(window.opera&&document.documentElement){
			...
			if(!oDF){var oDF=document.createElement('input');
				oDF.id='op-drag-fix';
